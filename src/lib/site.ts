export const siteConfig = {
  ...
  shortName: 'Landing Page para Advogados',
  legalName: 'Landing Page para Advogados',
  url: 'https://landingpageparaadvogados.com',
  ogImage: 'https://landingpageparaadvogados.com/images/landing-page-para-advogados.jpg',
  description:
    'Criação de landing pages profissionais para advogados com mais de 20 anos de experiência. Design responsivo, SEO otimizado e conformidade total com a OAB.',
  keywords: [
    'landing page para advogados',
    'página de captação jurídica',
    'site para advogados',
    'criação de site jurídico',
    'página de conversão para advocacia',
    'marketing digital jurídico',
    'site profissional para advogados',
